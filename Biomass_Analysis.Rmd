...
# group by plot and sum biomass AND sd + se
...
# group by plot and sum mortality + adding proportion
...
# group by treatment and sum biomass + adding sd and se
...
# group by treatment and sum mortality + add pct
...
# plotting species data in a table ********to be trouble shooted
```{r}
