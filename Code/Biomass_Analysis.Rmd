...
elings_data <- read.csv(here("ElingsMonitoringData_2024Feb.csv")) %>% 
  clean_names() %>% 
...
ggplot(mort_plot, aes(x = plot_id, y = mort_sum, fill = treatment)) +
  geom_col() +
  theme_bw() +
  labs(x = "Plot ID",
...
#average biomass per treatment with error bars
...
ggplot(data = biomass_treatment, 
       aes(x = treatment, y = mean_biomass)) +
  geom_col() +
  geom_errorbar(
    aes(ymin = mean_biomass - se,
